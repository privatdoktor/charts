...
@immutable
class EcgRendererSpec<D> extends SmallTickRendererSpec<D> {
	const EcgRendererSpec( {
	...
	TickDrawStrategy<D> createDrawStrategy(
		...
		new EcgTickDrawStrategy<D>( context, graphicsFactory,
			tickLengthPx: tickLengthPx,
			lineStyleSpec: lineStyle,
	...
	bool operator ==( Object other ) {
		return identical( this, other ) ||
			(other is EcgRendererSpec && super == (other));
	}
...
class EcgTickDrawStrategy<D> extends BaseTickDrawStrategy<D> {
	int tickLength;
	LineStyle lineStyle;
	...
	void drawPoints(ChartCanvas canvas, Tick<D> tick, AxisOrientation orientation, Rectangle<int> axisBounds, Rectangle<int> drawAreaBounds, bool isFirst, bool isLast, Point<num> lineStart, Point<num> lineEnd) {
